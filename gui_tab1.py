...
def initialize_vars(self):
    ...
    self.vars['DEFAULTS_FILENAME'] = "current_law_policy_vat_Indonesia_category.json"
    self.vars['GROWFACTORS_FILENAME'] = "growfactors_vat_indo_static.csv" 
    self.vars['pit_data_filename'] = "sampled_merged_susenas_Indo_utf8.csv"
    self.vars['pit_weights_filename'] = "weight_vat_indo_utf8.csv"
    self.vars['pit_records_variables_filename'] = "records_variable_indo_category.json"
    self.vars['pit_benchmark_filename'] = "tax_incentives_benchmark_pit_training.json"
    self.vars['pit_elasticity_filename'] = "elasticity_pit_training.json"
    self.vars['pit_functions_filename'] = "functions_vat_indo_category.py"
    self.vars['pit_function_names_filename'] = "function_names_vat_indo_category.json"
    self.vars['pit_distribution_json_filename'] = "vat_distribution_indo.json"   
    ...
    self.vars['vat_benchmark_filename'] = "tax_incentives_benchmark_pit_training.json"
    ...
    """
    self.vars['DEFAULTS_FILENAME'] = "current_law_policy_vat_Indonesia_susenas_2018.json"
    self.vars['GROWFACTORS_FILENAME'] = "growfactors_vat_indo_static.csv" 
    self.vars['vat_data_filename'] = "sampled_merged_susenas_Indo_utf8.csv"
    self.vars['vat_weights_filename'] = "weight_vat_indo_utf8.csv"
    self.vars['vat_records_variables_filename'] = "records_variables_vat_indo_ade.json"
    self.vars['vat_benchmark_filename'] = "tax_incentives_benchmark_pit_training.json"
    self.vars['vat_elasticity_filename'] = "elasticity_pit_training.json"
    self.vars['vat_functions_filename'] = "generated_vat_functions.py"
    self.vars['vat_function_names_filename'] = "function_names_vat_indo_ade.json"
    self.vars['vat_distribution_json_filename'] = "vat_distribution_indo.json"   
    self.vars['gdp_filename'] = 'gdp_nominal_training.csv'
    """
    ...
    self.vars['SALARY_VARIABLE'] = "CONS_total"
...
def display_entry(self, widget, tax_type):
    ...
    if not self.vars[tax_type]:
        ...
        self.entry_policy_filename[tax_type] = Entry(self.TAB1, width=10, font = self.fontStyle)
