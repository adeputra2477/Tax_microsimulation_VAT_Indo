...
vars['pit_functions_filename'] = "generated_vat_functions_food.py"
vars['pit_function_names_filename'] = "function_names_vat_indo_ade_food.json"
vars['pit_distribution_json_filename'] = "vat_distribution_indo_food.json"
...
vars["end_year"] = 2027
vars["SALARY_VARIABLE"] = "CONS_Food"
vars['elasticity_filename'] = "elasticity_pit_training.json"
vars['DIST_VARIABLES'] = ['weight', 'CONS_Food', 'vat']
vars['DIST_TABLE_COLUMNS'] = ['weight', 'CONS_Food', 'vat']        
...
# dump out records
dump_vars = ['id_n', 'Year', 'CONS_Food', 'vat']
...
dumpdf = dumpdf.sort_values(by=['CONS_Food'])
# Extract relevant field
values_pre = dumpdf['CONS_Food'].dropna().values  # Remove NaNs if any
gini_pre = calc_gini(values_pre)
print(f'Gini of Food Consumption Pre Reform : {gini_pre:.2f}')
...
title = 'Kakwani Index : ' 
# Plot Lorenz Curve
label1 = "Lorenz Curve of Food Consumption"
