...
vars['pit_functions_filename'] = "generated_vat_functions_non_food.py"
vars['pit_function_names_filename'] = "function_names_vat_indo_ade_non_food.json"
vars['pit_distribution_json_filename'] = "vat_distribution_indo_nonfood.json"
...
vars["end_year"] = 2027
vars["SALARY_VARIABLE"] = "CONS_Nonfood"
vars['elasticity_filename'] = "elasticity_pit_training.json"
vars['DIST_VARIABLES'] = ['weight', 'CONS_Nonfood', 'vat']
vars['DIST_TABLE_COLUMNS'] = ['weight', 'CONS_Nonfood', 'vat']        
...
# dump out records
dump_vars = ['id_n', 'Year', 'CONS_Nonfood', 'vat']
...
dumpdf.to_csv('app1-dump_vat0.csv', columns=column_order,
...
dumpdf = dumpdf.sort_values(by=['CONS_Nonfood'])
# Extract relevant field
values_pre = dumpdf['CONS_Nonfood'].dropna().values  # Remove NaNs if any
gini_pre = calc_gini(values_pre)
print(f'Gini of Non Food Consumption Pre Reform : {gini_pre:.2f}')
...
title = 'Kakwani Index : ' 
# Plot Lorenz Curve
label1 = "Lorenz Curve of Non Food Consumption"
