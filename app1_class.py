...
vars['GROWFACTORS_FILENAME'] = "growfactors_indo.csv" 
vars['pit_data_filename'] = "vat_sample_indo.csv"
vars['pit_weights_filename'] = "vat_sample_indo_weights.csv"
...
# dump out records
dump_vars = ['id_n', 'Year', 'CONS_total', 'vat_food', 'vat_non_food', 'vat']
...
gini_pre = calc_gini(dumpdf['vat1'])
print(gini_pre)
gini_post=calc_gini(dumpdf['vat2'])
print(gini_post)
