...
def tab6(self):
    ...
    """
    self.combo_1_TAB6_x = 0.1
    self.combo_1_TAB6_y = 0.1
    
    self.TAB6_combo_entry_gap_x = 0.001
...
def display_chart(self, event, global_vars):    
    ...
    if (selected_chart==tax_type+'_revenue_projection'):        
        ...
        plt.plot(cum_pop, cum_income, marker='o', markevery=0.3, label="Lorenz Curve Income")
        plt.plot(cum_pop, cum_tax1, marker='s', markevery=0.3, label="Concentration Curve Current Tax")
        plt.plot(cum_pop, cum_tax2, marker='s', markevery=0.2, label="Concentration Curve Post Reform Tax", color='red')
        ...
        plt.annotate(f"Kakwani Index Post Reform:  {gini_tax2-gini_income:.2f}", 
                     xy=(0.02, 0.65),
                     fontsize=10, color='black')
